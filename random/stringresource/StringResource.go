...
import (
	...
	"github.com/cdktn-io/cdktn-provider-random-go/random/v15/stringresource/internal"
...
func (j *jsiiProxy_StringResource) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_StringResource) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_StringResource) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_StringResource) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_StringResource) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_StringResource)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_StringResource)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_StringResource)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func StringResource_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_StringResource) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StringResource) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_StringResource) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_StringResource) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_StringResource) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_StringResource) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
