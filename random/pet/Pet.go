...
import (
	...
	"github.com/cdktn-io/cdktn-provider-random-go/random/v14/pet/internal"
...
func (j *jsiiProxy_Pet) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Pet) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Pet) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Pet) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Pet) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_Pet)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Pet)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Pet)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func Pet_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (p *jsiiProxy_Pet) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_Pet) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (p *jsiiProxy_Pet) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (p *jsiiProxy_Pet) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
