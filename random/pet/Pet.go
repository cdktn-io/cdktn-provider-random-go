...
import (
	...
	"github.com/cdktn-io/cdktn-provider-random-go/random/v15/pet/internal"
...
func (p *jsiiProxy_Pet) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (p *jsiiProxy_Pet) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
