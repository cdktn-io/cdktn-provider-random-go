...
import (
	...
	"github.com/cdktn-io/cdktn-provider-random-go/random/v15/integer/internal"
...
func (j *jsiiProxy_Integer) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Integer) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Integer) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Integer) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Integer) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_Integer)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Integer)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Integer)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func Integer_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (i *jsiiProxy_Integer) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_Integer) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (i *jsiiProxy_Integer) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (i *jsiiProxy_Integer) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (i *jsiiProxy_Integer) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (i *jsiiProxy_Integer) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
