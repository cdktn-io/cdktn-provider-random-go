...
import (
	...
	"github.com/cdktn-io/cdktn-provider-random-go/random/v15/uuid/internal"
...
func (j *jsiiProxy_Uuid) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Uuid) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Uuid) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Uuid) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Uuid) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_Uuid)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Uuid)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Uuid)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func Uuid_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (u *jsiiProxy_Uuid) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (u *jsiiProxy_Uuid) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (u *jsiiProxy_Uuid) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (u *jsiiProxy_Uuid) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (u *jsiiProxy_Uuid) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (u *jsiiProxy_Uuid) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
