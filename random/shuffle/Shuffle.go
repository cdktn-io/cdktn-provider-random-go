...
import (
	...
	"github.com/cdktn-io/cdktn-provider-random-go/random/v15/shuffle/internal"
...
func (j *jsiiProxy_Shuffle) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_Shuffle) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_Shuffle) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_Shuffle) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_Shuffle) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_Shuffle)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_Shuffle)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_Shuffle)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func Shuffle_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_Shuffle) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_Shuffle) ImportFrom(id *string, provider cdktn.TerraformProvider) {
...
func (s *jsiiProxy_Shuffle) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (s *jsiiProxy_Shuffle) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (s *jsiiProxy_Shuffle) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (s *jsiiProxy_Shuffle) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
