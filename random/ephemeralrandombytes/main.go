...
func init() {
	_jsii_.RegisterClass(
		"@cdktn/provider-random.ephemeralRandomBytes.EphemeralRandomBytes",
		reflect.TypeOf((*EphemeralRandomBytes)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			j := jsiiProxy_EphemeralRandomBytes{}
			_jsii_.InitJsiiProxy(&j.Type__cdktnTerraformEphemeralResource)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"@cdktn/provider-random.ephemeralRandomBytes.EphemeralRandomBytesConfig",
		reflect.TypeOf((*EphemeralRandomBytesConfig)(nil)).Elem(),
	)
}
